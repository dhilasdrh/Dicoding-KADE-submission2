...
import com.example.kadesubmission2.activity.MatchSearchActivity
import com.example.kadesubmission2.adapter.ViewPagerAdapter
...
class MatchFragment : Fragment(){
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        ...
        val viewPagerAdapter = ViewPagerAdapter(context, idLeague, childFragmentManager)
